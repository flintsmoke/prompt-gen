    ...
    const genre = [ 
        {name: 'Science Fiction', description: 'A genre of speculative fiction which typically deals with imaginative and futuristic concepts such as advanced science and technology, space exploration, time travel, parallel universes, and extraterrestrial life. It has been called the "literature of ideas", and it often explores the potential consequences of scientific, social, and technological innovations.'},
        {name: 'Fantasy', description: 'A genre of speculative fiction involving magical elements, typically set in a fictional universe and sometimes inspired by mythology and folklore. Most fantasy uses magic or other supernatural elements as a main plot element, theme, or setting. Magic, magic practitioners (sorcerers, witches and so on) and magical creatures are common in many of these worlds.'},
        {name: 'Mystery', description: 'A fiction genre where the nature of an event, usually a murder or other crime, remains mysterious until the end of the story. Often within a closed circle of suspects, each suspect is usually provided with a credible motive and a reasonable opportunity for committing the crime. The central character is often a detective (such as Sherlock Holmes), who eventually solves the mystery by logical deduction from facts presented to the reader.'},
        {name: 'Thriller', description: ''},
        {name: 'Dystopian', description: ''},
        {name: 'Steampunk', description: ''},
        {name: 'Romance', description: ''},
        {name: 'Historical Fiction', description: ''},
        {name: 'Post-Apocalyptic', description: ''},
        {name: '', description: ''},
        {name: '', description: ''},
        {name: '', description: ''},
    ];
                ...
                /*    <div class="genre" id="t">
                        ...
                        <div class="personalities box">
                            <div class="personality" id="architect">
                                <h3>Architect</h3>
                            ...
                            <div class="personality" id="logician">
                                <h3>Logician</h3>
                            ...
                            <div class="personality" id="commander">
                                <h3>Commander</h3>
                            ...
                            <div class="personality" id="debater">
                                <h3>Debater</h3>
                            ...
                            <div class="personality" id="advocate">
                                <h3>Advocate</h3>
                            ...
                            <div class="personality" id="mediator">
                                <h3>Mediator</h3>
                            ...
                            <div class="personality" id="protagonist">
                                <h3>Protagonists</h3>
                            ...
                            <div class="personality" id="campaigner">
                                <h3>Campaigners</h3>
                            ...
                            <div class="personality" id="logistician">
                                <h3>Logistician</h3>
                                <h5>Most reliable</h5>
                                <ul>
                                    <li>Organized</li>
                            ...
                            <div class="personality" id="defender">
                                <h3>Defender</h3>
                                <h5>Most loyal</h5>
                                <ul>
                            ...
                            <div class="personality" id="executive">
                                <h3>Executive</h3>
                                <h5>Most forceful</h5>
                                <ul>
                            ...
                            <div class="personality" id="consul">
                                <h3>Consul</h3>
                            ...
                            <div class="personality" id="virtuoso">
                                <h3>Virtuoso</h3>
                            ...
                            <div class="personality" id="adventurer">
                                <h3>Adventurer</h3>
                                <h5>Most artistic</h5>
                                <ul>
                                    <li>Warm</li>
                            ...
                            <div class="personality" id="entrepreneur">
                                <h3>Entrepreneur</h3>
                                <h5>Most fun</h5>
                                <ul>
                            ...
                            <div class="personality" id="entertainer">
                                <h3>Entertainer</h3>
                                <h5>Most generous</h5>
                                <ul>
                                    <li>Sociable</li>
                        ...
                        <div class="characters box">
                            ...
                            <div class="character" id="magician">
                                <h3>The Magician</h3>
                            ...
                            <div class="character" id="explorer">
                                <h3>The Explorer</h3>
                            ...
                            <div class="character" id="innocent">
                                <h3>The Innocent</h3>
                            ...
                            <div class="character" id="creator">
                                <h3>The Creator</h3>
                            ...
                            <div class="character" id="caregiver">
                                <h3>The Caregiver</h3>
                            ...
                            <div class="character" id="everyman">
                                <h3>The Everyman</h3>
